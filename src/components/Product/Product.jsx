...
import { addCout } from '../../redux/counter/countSlice';
import like from "../../assets/svg/li.svg"
          ...
          <div className='sales container'>
               <div className='flash'>
                    ...
                    <div className='flash-icons'>
                         ...
                         <button  onClick={() => Dispach(addCout ())}>add</button>
                    </div>
               </div>
                         ...
                         <div key={item.map}>
                              <div className='product-top'>
                                   ...
                                   <div className='product-icons'>
                                        <img onClick={() => dispatchEvent(addWish(item))} src={like} alt="" />
                                        <img src="" alt="" />
                                   </div>
                                   {item.discount && (
                                        <div className='sale'>
